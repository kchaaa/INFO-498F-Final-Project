...
If the sample is below 5 ppb, the water is fine. 
If the sample is between 5 ppb and 15 ppb, then the water is relatively safe, but it is on the cusp of the danger. 
If the sample is above 15 ppb,  then the households are at high risk and the EPA and the government needs to take action because 15 ppb is the allowed EPA level.
